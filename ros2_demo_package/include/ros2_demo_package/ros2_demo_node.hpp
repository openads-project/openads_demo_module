...
class Ros2DemoNode : public rclcpp::Node {
 ...
 private:
   ...
   */
  rclcpp_action::GoalResponse actionHandleGoal(const rclcpp_action::GoalUUID& uuid, std::shared_ptr<const ros2_demo_package_interfaces::action::Fibonacci::Goal> goal);
   ...
   */
  rclcpp_action::CancelResponse actionHandleCancel(const std::shared_ptr<rclcpp_action::ServerGoalHandle<ros2_demo_package_interfaces::action::Fibonacci>> goal_handle);
   ...
   * @param goal_handle action goal handle
   */
  void actionHandleAccepted(const std::shared_ptr<rclcpp_action::ServerGoalHandle<ros2_demo_package_interfaces::action::Fibonacci>> goal_handle);
   ...
   * @param goal_handle action goal handle
   */
  void actionExecute(const std::shared_ptr<rclcpp_action::ServerGoalHandle<ros2_demo_package_interfaces::action::Fibonacci>> goal_handle);
